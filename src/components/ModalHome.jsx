...
const ModalHome = ({ isOpen, onClose, children }) => {
    return isOpen ? (
        ...
        <div data-modal-backdrop="static" data-modal-placement="top-center" tabIndex="-1" aria-hidden="true" id="request_qoute" className="fixed top-0 left-0 right-0   w-full p-6 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-0rem)] max-h-full bg-gray-500 bg-opacity-50 transition-opacity z-[99999]">
